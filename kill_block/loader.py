...
libbpf.bpf_program__attach_lsm.argtypes = [c_void_p]
libbpf.bpf_program__attach_lsm.restype = c_void_p
...
BPF_OBJ_FILE = b"kill_block.o"
PROGRAM_NAME = b"block_cross_container_kill"
